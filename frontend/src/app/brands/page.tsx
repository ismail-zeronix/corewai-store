          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {brands.map((brand) => (
              <Link
                ...
                className="flex h-24 items-center justify-center rounded-xl border border-border bg-white px-4 text-center transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-elevated"
              >
